...
const AssignedDeliveries = () => {
    ...
    const { data: parcels = [], refetch } = useQuery({
        ...
        queryFn: async () => {
            const res = await axiosSecure.get(`/parcels/rider?riderEmail=${user.email}&deliveryStatus=driver_assign`);
            return res.data;
        }
    })
    ...
    return (
        <div>
            <h1 className='text-4xl font-extrabold'>Assigned Deliveries: {parcels.length}</h1>
